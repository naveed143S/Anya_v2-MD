...
global.botname = process.env.BotName || "N S" 
global.author = process.env.Author || "@PikaBotz" 
global.packname = process.env.PackName || NS" 
global.myweb = process.env.Web || "https://github.com/PikaBotz" 
global.footer = process.env.Footer || "© N S" 
global.prefa = process.env.Prefix || ['-'] 
global.themeemoji = process.env.ThemeEmoji || "🎐" 
global.ownername = process.env.Owner_Name || "Naveed~Baloch" 
global.ownernumber = process.env.Owner_Number || "923075715150" 
global.adress = process.env.Continent || "Pakistan, Rang pur" 
...
module.exports = {
  botname: process.env.BotName || "N S", 
  author: process.env.Author || "@NS",
  packname: process.env.PackName || "Naveed Baloch",
  myweb: process.env.Web || "https://github.com/PikaBotz",
  footer: process.env.Footer || "© Naveed Baloch",
  prefa: process.env.Prefix || ['-'],
  themeemoji: process.env.ThemeEmoji || "🎐",
  ownername: process.env.Owner_Name || "Pika~Kun",
  ownernumber: process.env.Owner_Number || "923075715150",
  adress: process.env.Continent || "Pakistan",
  ...
  sessionId: process.env.SESSION_ID || "NS", 
